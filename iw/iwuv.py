...
def saveSqlFile(fileName,lst):
    try:
        ...
        for info in lst:
            ...
            tmp = u"insert into uivinfo (vid,vname,userid,username,thumburl,views,likes,pri) values ('{}','{}','{}','{}','{}',{},{},{}) \
            on duplicate key update vname = '{}',userid='{}',username='{}',thumburl='{}',views={},likes={},pri={} ;\n".format( \
                info['vid'],vname,userid,username,info['thumburl'],info['views'],info['likes'],info['pri'],\
                vname,userid,username,info['thumburl'],info['views'],info['likes'],info['pri'])
            f.write(tmp)
    except Exception as e:
        print info
        print (e)
...
if __name__ == '__main__':
    ...
    sqlFile = '/tmp/iv.sql'
    for u in users:
        vlistPath = rootPath+'/users/'+u+'/videos'
        params = {}
